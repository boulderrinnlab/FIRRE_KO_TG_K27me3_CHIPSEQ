...
fl <- list.files("/scratch/Shares/rinn/JR/FIRRE_KO_TG_K27me3_CHIPSEQ/results_all_individual_runs/broad_peaks", full.names=TRUE)
peaks <- lapply(fl, rtracklayer::import)
names(peaks) <- gsub("/scratch/Shares/rinn/JR/FIRRE_KO_TG_K27me3_CHIPSEQ/results_all_individual_runs/broad_peaks/|_peaks.broadPeak", "", fl)
